				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group clearfix">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Account</label>
							<label class="col-xs-8 col-sm-8 col-md-1">:</label>
							...
							<div class="col-xs-1 col-sm-1 col-md-1" style="padding-left:0;margin-left: -3px;">
