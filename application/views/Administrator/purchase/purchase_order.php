			...
			<div class="widget-body">
				<div class="widget-main">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-xs-4 col-sm-4 control-label no-padding-right"> Supplier </label>
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label no-padding-right"> Product </label>
									<div class="col-xs-7 col-sm-7">
								...
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label no-padding-right"> </label>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Sub Total</label>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right"> Vat </label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Discount</label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Transport / Labour Cost</label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Total</label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Paid</label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-6 col-sm-6 control-label no-padding-right">Previous Due</label>
												<label class="col-xs-6 col-sm-6 control-label no-padding-right">Due</label>
											</div>
										</td>
									</tr>
