					...
					<div class="row">
						...
						<div class="col-sm-5 clearfix">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									<label class="col-xs-3 col-sm-3 control-label no-padding-right"> </label>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Discount Persent</label>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label no-padding-right">Transport Cost</label>
												<div class="col-xs-12 col-sm-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 control-label">Due</label>
