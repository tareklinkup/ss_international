                    ...
                    <div class="col-xs-6" style="margin-top:15px">
                        ...
                        <table class="pull-left">
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; padding-left:5px">{{ sales.SaleMaster_DueAmount == null ? ' 0.00' : sales.SaleMaster_DueAmount  }}</td>
                            </tr>
                            <tr>
				...
				printWindow.document.write(`
                    ...
                    <body>
                        <div class="container">
                            <table style="width:100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="col-xs-12" style="background-color: #0000000f;">
                                                    ${invoiceContent}
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <div class="row" style="margin-bottom:5px;padding-bottom:6px;position:fixed;left:0;bottom:15px;width:100%;">
                                <div class="col-xs-6">
                                <span style="text-decoration:overline;">Customer Received by</span><br><br>
                                </div>
                                <div class="col-xs-6 text-right" >
                                    <span style="text-decoration:overline;" style="float:right">Authorized by SSI</span>
                                </div>
                            </div>
